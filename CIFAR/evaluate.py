...
parser.add_argument('--data', type=Path, metavar='DIR', default="./dataset/",
                    help='path to dataset')
parser.add_argument('--pretrained', type=Path, metavar='FILE', default="./checkpoint/resnet18-cifar100-256-2048.pth",
