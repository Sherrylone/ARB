...
from dataset import ImageNetTrain, ImageNetVal
import torchvision
...
parser.add_argument('--pretrained', type=Path, metavar='FILE', required=True,
...
parser.add_argument('--checkpoint-dir', default='./checkpoint_eval/', type=Path,
...
def main_worker(gpu, args):
    ...
    outdim = 100 if 'imagenet100' in resume else 1000

    if 'resnet18' in resume:
        model = models.resnet.resnet18()
        model.fc = nn.Linear(512, outdim)
    else:
    ...
    train_dataset = ImageNetTrain('/mnt/lustre/share/images/train/', transforms.Compose([
            transforms.RandomResizedCrop(224),
            transforms.RandomHorizontalFlip(),
            transforms.ToTensor(),
            normalize,
        ]), outdim)
    val_dataset = ImageNetVal('/mnt/lustre/share/images/val/', transforms.Compose([
            transforms.Resize(256),
            transforms.CenterCrop(224),
            transforms.ToTensor(),
            normalize,
        ]), train_dataset.idx2idx)
